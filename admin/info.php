    ...
    <?php 
        ...
        if($act == "jkinfo"){
            ...
            <div class="panel panel-primary">
               ...
               <center>
                <h4>自动发送邮件：<?php echo "http://".$_SERVER['HTTP_HOST']."/ayangw/mon.php";?></h4>
                  <h4>自动补单：<?php echo "http://".$_SERVER['HTTP_HOST']."/ayangw/auto.php";?></h4>
                <h4>如不准确请以真实地址为准！</h4>
                <hr>
                 <a href="https://www.aliyun.com/" target="_balck">点击加入阿里云监控</a><br><br>
                <a href="http://blog.xinteam.cn" target="_balck">点击下载本地监控软件</a>
               </center>
                </div>
            </div>
            <?php 
